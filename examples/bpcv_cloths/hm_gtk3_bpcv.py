...
class main:
    ...
    def update_torch_data(self, str_txt):
        ...
        wpe = self.np_convs_weights[0].shape
        draw_conv = draw_data(self.np_convs_weights[0].reshape(wpe[0]*wpe[1],wpe[2],wpe[3]) )
        ax02.imshow(draw_conv, cmap = 'gray', origin = 'lower')
        ax02.set_title("conv1_weight")
