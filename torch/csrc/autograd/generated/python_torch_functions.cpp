...
static PyObject * THPVariable__has_same_tensorimpl_type(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_has_same_tensorimpl_type(Tensor input, Tensor other)",
  }, /*traceable=*/false);
  ...
  if (r.idx == 0) {
    return wrap(dispatch__has_same_tensorimpl_type(r.tensor(0), r.tensor(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_quantize_linear_per_channel(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "quantize_linear_per_channel(Tensor input, Tensor scales, Tensor zero_points, IntArrayRef axis, ScalarType dtype)",
  }, /*traceable=*/true);
  ...
  if (r.idx == 0) {
    return wrap(dispatch_quantize_linear_per_channel(r.tensor(0), r.tensor(1), r.tensor(2), r.intlist(3), r.scalartype(4)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyMethodDef torch_functions[] = {
  ...
  {"_has_same_tensorimpl_type", (PyCFunction)THPVariable__has_same_tensorimpl_type, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  {"_index_copy_", (PyCFunction)THPVariable__index_copy_, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  {"_index_put_impl_", (PyCFunction)THPVariable__index_put_impl_, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"_mkldnn_reshape", (PyCFunction)THPVariable__mkldnn_reshape, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  {"_mkldnn_transpose", (PyCFunction)THPVariable__mkldnn_transpose, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  {"_mkldnn_transpose_", (PyCFunction)THPVariable__mkldnn_transpose_, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"native_layer_norm", (PyCFunction)THPVariable_native_layer_norm, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"quantize_linear_per_channel", (PyCFunction)THPVariable_quantize_linear_per_channel, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"trapz", (PyCFunction)THPVariable_trapz, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
