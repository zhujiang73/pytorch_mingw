...
Tensor & VariableType::_addmm_out(Tensor & out, const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) {
  RECORD_FUNCTION("_addmm_out", std::vector<c10::IValue>({out, self, mat1, mat2, beta, alpha}), Function::peek_at_next_sequence_nr());
...
Tensor VariableType::_copy_from(const Tensor & self, const Tensor & dst, bool non_blocking) {
  RECORD_FUNCTION("_copy_from", std::vector<c10::IValue>({self, dst}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  auto& dst_ = unpack(dst, "dst", 1);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self, dst )) {
    grad_fn = std::shared_ptr<NotImplemented>(new NotImplemented("_copy_from"), deleteFunction);
...
bool VariableType::_has_same_tensorimpl_type(const Tensor & self, const Tensor & other) {
  RECORD_FUNCTION("_has_same_tensorimpl_type", std::vector<c10::IValue>({self, other}), Function::peek_at_next_sequence_nr());
  auto result = TypeDefault::_has_same_tensorimpl_type(self, other);
  return result;
}
Tensor & VariableType::_index_copy_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & source) {
  RECORD_FUNCTION("_index_copy_", std::vector<c10::IValue>({self, index, source}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  if (compute_requires_grad( self, index, source )) {
    grad_fn = std::shared_ptr<NotImplemented>(new NotImplemented("_index_copy_"), deleteFunction);
...
std::tuple<Tensor,Tensor> VariableType::_min(const Tensor & self, int64_t dim, bool keepdim) {
  RECORD_FUNCTION("_min", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
    grad_fn = std::shared_ptr<NotImplemented>(new NotImplemented("_min"), deleteFunction);
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  Tensor result0;
  Tensor result1;
...
std::tuple<Tensor,Tensor> VariableType::_symeig_helper(const Tensor & self, bool eigenvectors, bool upper) {
  RECORD_FUNCTION("_symeig_helper", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
    grad_fn = std::shared_ptr<NotImplemented>(new NotImplemented("_symeig_helper"), deleteFunction);
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  Tensor result0;
  Tensor result1;
...
Tensor VariableType::_var(const Tensor & self, bool unbiased) {
  RECORD_FUNCTION("_var", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
    grad_fn = std::shared_ptr<NotImplemented>(new NotImplemented("_var"), deleteFunction);
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
...
Tensor & VariableType::avg_pool2d_out(Tensor & out, const Tensor & self, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, bool ceil_mode, bool count_include_pad) {
  ...
  {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    at::avg_pool2d_out(out_, self_, kernel_size, stride, padding, ceil_mode, count_include_pad);
  }
  #ifndef NDEBUG
  if (out__storage_saved.has_value())
    AT_ASSERT(out__storage_saved.value().is_alias_of(out_.storage()));
...
Tensor VariableType::conv_transpose2d(const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef output_padding, IntArrayRef dilation) {
  RECORD_FUNCTION("conv_transpose2d", std::vector<c10::IValue>({self, weight, bias}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  ...
  if (compute_requires_grad( self, weight, bias )) {
    grad_fn = std::shared_ptr<ConvTranspose2DBackward>(new ConvTranspose2DBackward(), deleteFunction);
...
std::tuple<Tensor &,Tensor &,Tensor &> VariableType::conv_transpose2d_backward_out(Tensor & grad_input, Tensor & grad_weight, Tensor & grad_bias, const Tensor & grad_output, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, IntArrayRef stride, IntArrayRef padding, IntArrayRef output_padding, IntArrayRef dilation, const Tensor & columns, const Tensor & ones) {
  RECORD_FUNCTION("conv_transpose2d_backward_out", std::vector<c10::IValue>({grad_input, grad_weight, grad_bias, grad_output, self, weight, columns, ones}), Function::peek_at_next_sequence_nr());
...
Tensor & VariableType::conv_transpose3d_out(Tensor & out, const Tensor & self, const Tensor & weight, IntArrayRef kernel_size, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef output_padding, IntArrayRef dilation) {
  RECORD_FUNCTION("conv_transpose3d_out", std::vector<c10::IValue>({out, self, weight, bias}), Function::peek_at_next_sequence_nr());
  auto& out_ = unpack(out, "out", 0);
  auto& self_ = unpack(self, "self", 1);
...
Tensor VariableType::gelu(const Tensor & self) {
  RECORD_FUNCTION("gelu", std::vector<c10::IValue>({self}), Function::peek_at_next_sequence_nr());
  auto& self_ = unpack(self, "self", 0);
  std::shared_ptr<GeluBackward> grad_fn;
  if (compute_requires_grad( self )) {
    grad_fn = std::shared_ptr<GeluBackward>(new GeluBackward(), deleteFunction);
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->self_ = SavedVariable(self, false);
  }
  torch::jit::Node* node = nullptr;
...
Tensor VariableType::nonzero(const Tensor & self) {
  ...
  std::shared_ptr<NotImplemented> grad_fn;
  if (compute_requires_grad( self )) {
    grad_fn = std::shared_ptr<NotImplemented>(new NotImplemented("nonzero"), deleteFunction);
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
...
Tensor VariableType::poisson_nll_loss(const Tensor & input, const Tensor & target, bool log_input, bool full, double eps, int64_t reduction) {
  RECORD_FUNCTION("poisson_nll_loss", std::vector<c10::IValue>({input, target}), Function::peek_at_next_sequence_nr());
  torch::jit::Node* node = nullptr;
  std::shared_ptr<jit::tracer::TracingState> tracer_state;
  if (jit::tracer::isTracing()) {
    tracer_state = jit::tracer::getTracingState();
...
std::tuple<Tensor,Tensor> VariableType::pstrf(const Tensor & self, bool upper, Scalar tol) {
  ...
  auto tmp = ([&]() {
    at::AutoNonVariableTypeMode non_var_type_mode(true);
    return at::pstrf(self_, upper, tol);
  })();
...
std::tuple<Tensor,Tensor,Tensor> VariableType::quantized_lstm(const Tensor & input, TensorList hx, TensorList params, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional, bool batch_first) {
...
static auto& registerer = globalATenDispatch()
  ...
  .registerVariableOp<bool (const Tensor &, const Tensor &)>("aten::_has_same_tensorimpl_type(Tensor self, Tensor other) -> bool", &VariableType::_has_same_tensorimpl_type)
  ...
  .registerVariableOp<Tensor & (Tensor &, const Tensor &, IntArrayRef, IntArrayRef, IntArrayRef, bool, bool)>("aten::avg_pool2d(Tensor self, int[2] kernel_size, int[2] stride=[], int[2] padding=0, bool ceil_mode=False, bool count_include_pad=True, *, Tensor(a!) out) -> Tensor(a!)", &VariableType::avg_pool2d_out)
  ...
  .registerVariableOp<std::tuple<Tensor,Tensor> (const Tensor &, bool, Scalar)>("aten::pstrf(Tensor self, bool upper=True, Scalar tol=-1) -> (Tensor u, Tensor pivot)", &VariableType::pstrf)
  .registerVariableOp<std::tuple<Tensor,Tensor,Tensor> (const Tensor &, TensorList, TensorList, bool, int64_t, double, bool, bool, bool)>("aten::quantized_lstm(Tensor input, Tensor[] hx, Tensor[] params, bool has_biases, int num_layers, float dropout, bool train, bool bidirectional, bool batch_first) -> (Tensor, Tensor, Tensor)", &VariableType::quantized_lstm)
