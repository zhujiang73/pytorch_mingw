...
// @generated from tools/autograd\templates/python_nn_functions.cpp
...
static PyObject * THPVariable_avg_pool2d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "avg_pool2d(Tensor input, IntArrayRef[2] kernel_size, IntArrayRef[2] stride=None, IntArrayRef[2] padding=0, bool ceil_mode=False, bool count_include_pad=True, *, Tensor out=None)",
  }, /*traceable=*/true);
...
static PyObject * THPVariable_avg_pool3d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "avg_pool3d(Tensor input, IntArrayRef[3] kernel_size, IntArrayRef[3] stride=None, IntArrayRef[3] padding=0, bool ceil_mode=False, bool count_include_pad=True, *, Tensor out=None)",
  }, /*traceable=*/true);
...
static PyObject * THPVariable_conv_dilated2d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "conv_dilated2d(Tensor input, Tensor weight, IntArrayRef[2] kernel_size, Tensor? bias=None, IntArrayRef[2] stride=1, IntArrayRef[2] padding=0, IntArrayRef[2] dilation=1)",
  }, /*traceable=*/true);
...
static PyObject * THPVariable_conv_dilated3d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
  ...
  if (r.idx == 0) {
    return wrap(dispatch_conv_dilated3d(r.tensor(0), r.tensor(1), r.intlist(2), r.tensor(3), r.intlist(4), r.intlist(5), r.intlist(6)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_conv_transpose2d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "conv_transpose2d(Tensor input, Tensor weight, IntArrayRef[2] kernel_size, Tensor? bias=None, IntArrayRef[2] stride=1, IntArrayRef[2] padding=0, IntArrayRef[2] output_padding=0, IntArrayRef[2] dilation=1, *, Tensor out=None)",
  }, /*traceable=*/false);
  ...
  if (r.idx == 0) {
    if (r.isNone(8)) {
      return wrap(dispatch_conv_transpose2d(r.tensor(0), r.tensor(1), r.intlist(2), r.tensor(3), r.intlist(4), r.intlist(5), r.intlist(6), r.intlist(7)));
    } else {
      return wrap(dispatch_conv_transpose2d(r.tensor(0), r.tensor(1), r.intlist(2), r.tensor(3), r.intlist(4), r.intlist(5), r.intlist(6), r.intlist(7), r.tensor(8)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_conv_transpose3d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "conv_transpose3d(Tensor input, Tensor weight, IntArrayRef[3] kernel_size, Tensor? bias=None, IntArrayRef[3] stride=1, IntArrayRef[3] padding=0, IntArrayRef[3] output_padding=0, IntArrayRef[3] dilation=1, *, Tensor out=None)",
  }, /*traceable=*/false);
  ...
  if (r.idx == 0) {
    if (r.isNone(8)) {
      return wrap(dispatch_conv_transpose3d(r.tensor(0), r.tensor(1), r.intlist(2), r.tensor(3), r.intlist(4), r.intlist(5), r.intlist(6), r.intlist(7)));
    } else {
      return wrap(dispatch_conv_transpose3d(r.tensor(0), r.tensor(1), r.intlist(2), r.tensor(3), r.intlist(4), r.intlist(5), r.intlist(6), r.intlist(7), r.tensor(8)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyMethodDef nn_functions[] = {
  ...
  {"col2im", (PyCFunction)THPVariable_col2im, METH_VARARGS | METH_KEYWORDS, NULL},
  {"conv_dilated2d", (PyCFunction)THPVariable_conv_dilated2d, METH_VARARGS | METH_KEYWORDS, NULL},
  {"conv_dilated3d", (PyCFunction)THPVariable_conv_dilated3d, METH_VARARGS | METH_KEYWORDS, NULL},
  {"conv_transpose2d", (PyCFunction)THPVariable_conv_transpose2d, METH_VARARGS | METH_KEYWORDS, NULL},
  {"conv_transpose3d", (PyCFunction)THPVariable_conv_transpose3d, METH_VARARGS | METH_KEYWORDS, NULL},
  ...
  {"fractional_max_pool3d", (PyCFunction)THPVariable_fractional_max_pool3d, METH_VARARGS | METH_KEYWORDS, NULL},
  {"gelu", (PyCFunction)THPVariable_gelu, METH_VARARGS | METH_KEYWORDS, NULL},
  ...
  {"im2col", (PyCFunction)THPVariable_im2col, METH_VARARGS | METH_KEYWORDS, NULL},
  ...
  {"linear", (PyCFunction)THPVariable_linear, METH_VARARGS | METH_KEYWORDS, NULL},
  {"log_sigmoid", (PyCFunction)THPVariable_log_sigmoid, METH_VARARGS | METH_KEYWORDS, NULL},
  {"max_pool2d_with_indices", (PyCFunction)THPVariable_max_pool2d_with_indices, METH_VARARGS | METH_KEYWORDS, NULL},
  {"max_pool3d_with_indices", (PyCFunction)THPVariable_max_pool3d_with_indices, METH_VARARGS | METH_KEYWORDS, NULL},
  ...
  {"mkldnn_linear", (PyCFunction)THPVariable_mkldnn_linear, METH_VARARGS | METH_KEYWORDS, NULL},
  {"mkldnn_reorder_conv2d_weight", (PyCFunction)THPVariable_mkldnn_reorder_conv2d_weight, METH_VARARGS | METH_KEYWORDS, NULL},
  ...
  {"one_hot", (PyCFunction)THPVariable_one_hot, METH_VARARGS | METH_KEYWORDS, NULL},
  ...
  {"upsample_bicubic2d", (PyCFunction)THPVariable_upsample_bicubic2d, METH_VARARGS | METH_KEYWORDS, NULL},
