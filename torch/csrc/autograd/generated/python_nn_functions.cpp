...
static PyObject * THPVariable_log_softmax(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "log_softmax(Tensor input, int64_t dim, *, Tensor out=None)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      ...
      return wrap(dispatch_log_softmax(r.tensor(0), r.toInt64(1), r.tensor(2)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_multi_margin_loss(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "multi_margin_loss(Tensor input, Tensor target, Scalar p=1, Scalar margin=1, Tensor weight=None, bool size_average=True, *, Tensor out=None)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(6)) {
      return wrap(dispatch_multi_margin_loss(r.tensor(0), r.tensor(1), r.scalar(2), r.scalar(3), r.tensor(4), r.toBool(5)));
    } else {
      return wrap(dispatch_multi_margin_loss(r.tensor(0), r.tensor(1), r.scalar(2), r.scalar(3), r.tensor(4), r.toBool(5), r.tensor(6)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_softmax(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "softmax(Tensor input, int64_t dim, *, Tensor out=None)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      ...
      return wrap(dispatch_softmax(r.tensor(0), r.toInt64(1), r.tensor(2)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_upsample_bilinear2d(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "upsample_bilinear2d(Tensor input, IntList[2] output_size, *, Tensor out=None)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      return wrap(dispatch_upsample_bilinear2d(r.tensor(0), r.intlist(1)));
    } else {
      return wrap(dispatch_upsample_bilinear2d(r.tensor(0), r.intlist(1), r.tensor(2)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_upsample_linear1d(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "upsample_linear1d(Tensor input, IntList[1] output_size, *, Tensor out=None)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      return wrap(dispatch_upsample_linear1d(r.tensor(0), r.intlist(1)));
    } else {
      return wrap(dispatch_upsample_linear1d(r.tensor(0), r.intlist(1), r.tensor(2)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_upsample_trilinear3d(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "upsample_trilinear3d(Tensor input, IntList[3] output_size, *, Tensor out=None)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      return wrap(dispatch_upsample_trilinear3d(r.tensor(0), r.intlist(1)));
    } else {
      return wrap(dispatch_upsample_trilinear3d(r.tensor(0), r.intlist(1), r.tensor(2)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
