...
class Tensor:
    ...
    @overload
    def mean(self, dim: Union[_int, _size], keepdim: bool=False, *, dtype: Optional[_dtype]=None) -> Tensor: ...
    @overload
    ...
    @overload
    def prod(self, dim: _int, keepdim: bool=False, *, dtype: Optional[_dtype]=None) -> Tensor: ...
    ...
    def qr(self, some: bool=True) -> Tuple[Tensor, Tensor]: ...
    ...
    @overload
    def sum(self, dim: Union[_int, _size], keepdim: bool=False, *, dtype: Optional[_dtype]=None) -> Tensor: ...
    @overload
...
def _addmm(self: Tensor, mat1: Tensor, mat2: Tensor, *, beta: Number=1, alpha: Number=1, out: Optional[Tensor]=None) -> Tensor: ...
def _addmm_(self: Tensor, mat1: Tensor, mat2: Tensor, *, beta: Number=1, alpha: Number=1) -> Tensor: ...
...
def _copy_from(self: Tensor, dst: Tensor, non_blocking: bool=False) -> Tensor: ...
...
def _dequantize_linear(self: Tensor, scale: _float, zero_point: _int, dtype: _dtype) -> Tensor: ...
...
@overload
def _empty_affine_quantized(size: _size, *, scale: _float=1, zero_point: _int=0, memory_format: Optional[memory_format]=contiguous_format, dtype: _dtype=None, layout: layout=strided, device: Union[_device, str, None]=None, requires_grad:bool=False) -> Tensor: ...
@overload
def _empty_affine_quantized(*size: _int, scale: _float=1, zero_point: _int=0, memory_format: Optional[memory_format]=contiguous_format, dtype: _dtype=None, layout: layout=strided, device: Union[_device, str, None]=None, requires_grad:bool=False) -> Tensor: ...
...
def _has_same_tensorimpl_type(self: Tensor, other: Tensor) -> bool: ...
def _index_copy_(self: Tensor, dim: _int, index: Tensor, source: Tensor) -> Tensor: ...
def _index_put_impl_(self: Tensor, indices: Optional[Union[Tuple[Tensor, ...], List[Tensor]]], values: Tensor, accumulate: bool=False, unsafe: bool=False) -> Tensor: ...
...
def _max(self: Tensor, dim: _int, keepdim: bool=False, *, out: Optional[Tensor]=None) -> Tuple[Tensor, Tensor]: ...
def _min(self: Tensor, dim: _int, keepdim: bool=False, *, out: Optional[Tensor]=None) -> Tuple[Tensor, Tensor]: ...
...
def _mode(self: Tensor, dim: _int=-1, keepdim: bool=False, *, out: Optional[Tensor]=None) -> Tuple[Tensor, Tensor]: ...
...
def _per_tensor_affine_qtensor(self: Tensor, scale: _float, zero_point: _int) -> Tensor: ...
...
def _std(self: Tensor, unbiased: bool=True) -> Tensor: ...
...
def _var(self: Tensor, unbiased: bool=True) -> Tensor: ...
...
@overload
def empty(size: _size, *, memory_format: Optional[memory_format]=None, out: Optional[Tensor]=None, dtype: _dtype=None, layout: layout=strided, device: Union[_device, str, None]=None, requires_grad:bool=False) -> Tensor: ...
@overload
def empty(*size: _int, memory_format: Optional[memory_format]=None, out: Optional[Tensor]=None, dtype: _dtype=None, layout: layout=strided, device: Union[_device, str, None]=None, requires_grad:bool=False) -> Tensor: ...
@overload
def empty_like(self: Tensor) -> Tensor: ...
@overload
def empty_like(self: Tensor, *, memory_format: Optional[memory_format]=contiguous_format, dtype: _dtype=None, layout: layout=strided, device: Union[_device, str, None]=None, requires_grad:bool=False) -> Tensor: ...
...
@overload
def mean(self: Tensor, dim: Union[_int, _size], keepdim: bool=False, *, dtype: Optional[_dtype]=None, out: Optional[Tensor]=None) -> Tensor: ...
@overload
...
@overload
def nuclear_norm(self: Tensor, dim: Union[_int, _size], keepdim: bool=False, *, out: Optional[Tensor]=None) -> Tensor: ...
...
def poisson_nll_loss(input: Tensor, target: Tensor, log_input: bool, full: bool, eps: _float, reduction: _int) -> Tensor: ...
...
@overload
def prod(self: Tensor, dim: _int, keepdim: bool=False, *, dtype: Optional[_dtype]=None, out: Optional[Tensor]=None) -> Tensor: ...
...
def qr(self: Tensor, some: bool=True, *, out: Optional[Tensor]=None) -> Tuple[Tensor, Tensor]: ...
def quantize_linear(self: Tensor, scale: _float, zero_point: _int, dtype: _dtype) -> Tensor: ...
def quantize_linear_per_channel(self: Tensor, scales: Tensor, zero_points: Tensor, axis: _size, dtype: _dtype) -> Tensor: ...
...
@overload
def std_mean(self: Tensor, unbiased: bool=True) -> Tuple[Tensor, Tensor]: ...
@overload
def std_mean(self: Tensor, dim: Union[_int, _size], unbiased: bool=True, keepdim: bool=False) -> Tuple[Tensor, Tensor]: ...
@overload
...
@overload
def sum(self: Tensor, dim: Union[_int, _size], keepdim: bool=False, *, dtype: Optional[_dtype]=None, out: Optional[Tensor]=None) -> Tensor: ...
...
@overload
def var_mean(self: Tensor, unbiased: bool=True) -> Tuple[Tensor, Tensor]: ...
@overload
def var_mean(self: Tensor, dim: Union[_int, _size], unbiased: bool=True, keepdim: bool=False) -> Tuple[Tensor, Tensor]: ...
